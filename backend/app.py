...
"""
Flask API for OCR
Provides REST API for OCR functionality.
"""
...
MODELS = {
    ...
    'openrouter-gpt4o': {
        ...
        'site_name': os.getenv('OPENROUTER_SITE_NAME', 'OCR Web Interface')
    }
}
...
def ocr():
    ...
    try:
        ...
        # Prepare extra headers for OpenRouter if needed
        extra_headers = {}
        if model_id == 'openrouter-gpt4o':
            extra_headers = {
                'HTTP-Referer': model_config.get('site_url', 'http://localhost:3000'),
                'X-Title': model_config.get('site_name', 'OCR Web Interface')
            }
