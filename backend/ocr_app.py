...
class OCRApp:
    ...
    def __init__(self, api_url: str, api_key: str, model: str = "qwen2-vl-32b-instruct-awq", extra_headers: dict = None):
        """
        Initialize OCR app.
        ...
        Args:
            ...
            extra_headers: Optional extra HTTP headers (e.g., for OpenRouter)
        """
